        ...
        if (isLineChart) {
          ...
          mi.innerHTML = `
            ...
            <div style="display:flex;flex-wrap:wrap;gap:2px 8px;font-size:0.8rem;font-family:monospace">
              ...
              <span><span style="${ts}">10M</span><span style="color:#000000">${ma10Val?.toFixed(decPlaces) ?? '-'}</span></span>
      ...
      if (isLineChart) {
        ...
        tt.innerHTML = `
          ...
          <div class="flex gap-4 mt-2 text-[10px] font-mono">
            ...
            <div class="flex items-center gap-1"><span style="${ts}">10M:</span><span style="color:#000000">${ma10Val?.toFixed(decPlaces) ?? '-'}</span></div>
          </div>
